...
public class FriendsChatAdapter extends RecyclerView.Adapter {
    private final Context context;
    private ArrayList<DBFriendMessage> messageList;
    ...
    public FriendsChatAdapter(Context context, ArrayList<DBFriendMessage> messageList, String senderRoom, String receiverRoom) {
        this.context = context;
        this.messageList = messageList;
        this.sender_room = senderRoom;
        this.receiver_room = receiverRoom;

        mAuth = FirebaseAuth.getInstance();
        db = FirebaseDatabase.getInstance();
    }

    public FriendsChatAdapter(Context context, String receiver_id) {
        this.context = context;
    ...
    public void setMessageList(ArrayList<DBFriendMessage> messageList) {
        this.messageList = messageList;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == SENDER_VIEW_TYPE) {
            View view = LayoutInflater.from(context).inflate(R.layout.chat_sender_view, parent, false);
            return new SenderViewHolder(view);
        } else {
            View view = LayoutInflater.from(context).inflate(R.layout.chat_receiver_view, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        DBFriendMessage message = messageList.get(position);
        ...
        /*if (holder.getClass() == SenderViewHolder.class) {
            ...
            if (message.getImageUri() != null) {
                ...
                ((SenderViewHolder) holder).sender_message_time1.setText(time_stamp);
                ...
                ((SenderViewHolder) holder).sender_message_time2.setText(time_stamp);
            }
            ...
            if (message.getImageUri() != null) {
                ...
                ((ReceiverViewHolder) holder).Receiver_message_time1.setText(time_stamp);
                ...
                ((ReceiverViewHolder) holder).Receiver_message_time2.setText(time_stamp);
            }
        }*/
        if (holder.getClass() == FriendsChatAdapter.SenderViewHolder.class) {
            Date date = new Date(message.getTime());
            SimpleDateFormat dateFormat = new SimpleDateFormat("h:mm a");
            String time_stamp = dateFormat.format(date);
        ...
        holder.itemView.setOnLongClickListener(view -> {
            // String sender_room = mAuth.getCurrentUser().getUid()+ receiver_id;
            // String receiver_room = receiver_id + mAuth.getCurrentUser().getUid();

            new AlertDialog.Builder(context)
                    .setTitle("Delete")
                    .setMessage("Are you sure you want to delete -> " + message.getMessage())
                    .setPositiveButton("Yes", (dialogInterface, i) -> {
                        db.getReference().child("Chats").child(Objects.requireNonNull(mAuth.getCurrentUser()).getUid())
                                .child(receiver_id)
                                .child(message.getMessage_id())
                                .setValue(null).addOnSuccessListener(unused -> {
    ...
    public static class SenderViewHolder extends RecyclerView.ViewHolder {
        ...
        public SenderViewHolder(@NonNull View itemView) {
            ...
            //image layout
            sender_layout_image = itemView.findViewById(R.id.chat_sender_view_image_layout);
            sender_image_time = itemView.findViewById(R.id.chat_sender_view_image_time);
            sender_image = itemView.findViewById(R.id.chat_sender_view_messageImage);

            //video layout
            sender_layout_video = itemView.findViewById(R.id.chat_sender_view_video_layout);
            sender_video_time = itemView.findViewById(R.id.chat_sender_view_video_time);
            sender_video = itemView.findViewById(R.id.chat_sender_view_messageVideo);

            //music layout
            sender_layout_music = itemView.findViewById(R.id.chat_sender_view_music_layout);
            sender_music_time = itemView.findViewById(R.id.chat_sender_view_music_time);
            sender_music = itemView.findViewById(R.id.chat_sender_view_messageMusic);

            //file layout
            sender_layout_file = itemView.findViewById(R.id.chat_sender_view_file_layout);
            sender_file_time = itemView.findViewById(R.id.chat_sender_view_file_time);
            sender_file = itemView.findViewById(R.id.chat_sender_view_messageFile);

            //message layout
            sender_layout_message = itemView.findViewById(R.id.chat_sender_view_message_layout);
            sender_message_time = itemView.findViewById(R.id.chat_sender_view_message_time);
            sender_civ = itemView.findViewById(R.id.chat_sender_view_civ);
            sender_name = itemView.findViewById(R.id.chat_sender_view_name);
            sender_message = itemView.findViewById(R.id.chat_sender_view_message);
        }
    }
    ...
    public static class ReceiverViewHolder extends RecyclerView.ViewHolder {
        ...
        public ReceiverViewHolder(@NonNull View itemView) {
            super(itemView);
            //image layout
            receiver_layout_image = itemView.findViewById(R.id.chat_receiver_view_image_layout);
            receiver_image_time = itemView.findViewById(R.id.chat_receiver_view_image_time);
            receiver_image = itemView.findViewById(R.id.chat_receiver_view_messageImage);

            //video layout
            receiver_layout_video = itemView.findViewById(R.id.chat_receiver_view_video_layout);
            receiver_video_time = itemView.findViewById(R.id.chat_receiver_view_video_time);
            receiver_video = itemView.findViewById(R.id.chat_receiver_view_messageVideo);

            //music layout
            receiver_layout_music = itemView.findViewById(R.id.chat_receiver_view_music_layout);
            receiver_music_time = itemView.findViewById(R.id.chat_receiver_view_music_time);
            receiver_music = itemView.findViewById(R.id.chat_receiver_view_messageMusic);

            //file layout
            receiver_layout_file = itemView.findViewById(R.id.chat_receiver_view_file_layout);
            receiver_file_time = itemView.findViewById(R.id.chat_receiver_view_file_time);
            receiver_file = itemView.findViewById(R.id.chat_receiver_view_messageFile);

            //message layout
            receiver_layout_message = itemView.findViewById(R.id.chat_receiver_view_message_layout);
            receiver_message_time = itemView.findViewById(R.id.chat_receiver_view_message_time);
            receiver_civ = itemView.findViewById(R.id.chat_receiver_view_civ);
            receiver_name = itemView.findViewById(R.id.chat_receiver_view_name);
            receiver_message = itemView.findViewById(R.id.chat_receiver_view_message);
